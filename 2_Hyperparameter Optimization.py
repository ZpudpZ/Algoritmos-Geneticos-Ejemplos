...
def crear_individuo():
    """Crea un individuo (cromosoma) que representa una combinación de hiperparámetros."""
    # Hiperparámetros: [n_neighbors, p]
    # n_neighbors puede ser un entero entre 1 y 20
    # p puede ser 1 o 2 (distancia de Manhattan o Euclidiana)
...
def calcular_aptitud(individuo):
    """Calcula la aptitud (precisión) del individuo (combinación de hiperparámetros)."""
...
def cruzar(padre1, padre2):
    """Cruce de un solo punto para los hiperparámetros."""
...
for generacion in range(GENERACIONES):
    ...
    # Imprimimos el progreso en la consola
    print(
