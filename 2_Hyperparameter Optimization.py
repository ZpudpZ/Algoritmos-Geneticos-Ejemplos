...
# Definimos la "aptitud" que el algoritmo busca maximizar.
creator.create("FitnessMax", base.Fitness, weights=(1.0,))
# Un individuo es una lista de 2 elementos: [índice_C, índice_solver].
creator.create("Individual", list, fitness=creator.FitnessMax)

toolbox = base.Toolbox()

# Hiperparámetro 1: C (inversa de la fuerza de regularización).
C_VALUES = [0.01, 0.1, 1, 10, 100]
# Hiperparámetro 2: solver (algoritmo para optimización).
...
# Selección: Elige los individuos para reproducirse.
toolbox.register("select", tools.selTournament, tournsize=3)
# Cruzamiento: Combina los hiperparámetros de dos padres.
toolbox.register("mate", tools.cxUniform, indpb=0.5)

# Mutación: Cambia un hiperparámetro por otro aleatorio.
...
def main():
    ...
    # El ciclo principal del algoritmo genético
