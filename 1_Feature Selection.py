...
def evaluate_individual(individual):
    ...
    y devuelve la precisión como métrica de rendimiento.
    """
    if sum(individual) == 0:
...
# Selección: Elige los individuos para reproducirse (cruce y mutación).
toolbox.register("select", tools.selTournament, tournsize=3)
# Cruzamiento: Combina los genes de dos individuos.
toolbox.register("mate", tools.cxTwoPoint)
# Mutación: Cambia aleatoriamente los genes de un individuo.
